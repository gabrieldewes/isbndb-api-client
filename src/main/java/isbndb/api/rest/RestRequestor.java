...
import isbndb.api.http.HttpRequest;
import isbndb.api.http.HttpRequestFactory;
import isbndb.api.http.HttpResponse;
...
public class RestRequestor implements Requestor {
    ...
    public String request(Request request) throws IsbnDbException {
        ...
        if (!httpResponse.isSuccessful()) {
            ...
            builder.append("Problema ao conectar com ISBN DB\n\n");
